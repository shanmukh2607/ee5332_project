...
extern "C" void fir_hw_stub_wrapper(volatile void *, __cosim_s2__*);

extern "C" void apatb_fir_hw(volatile void * __xlx_apatb_param_y, __cosim_s2__* __xlx_apatb_param_x) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {
            ((short*)__xlx_apatb_param_y)[0] = y_pc_buffer[0].to_int64();
          }
        } // end transaction
      } // end file is good
